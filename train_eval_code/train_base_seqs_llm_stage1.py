...
def main(cfg):
    ...
    train_dataset = load_dataset('csv', data_files={"train": ["/data/zyp/jb_workspace/cell2sentence-master/20250212_cross_batch_data_processed/training_set/Human1_heart.csv",]})
    val_dataset = load_dataset('csv', data_files={"test": ["/data/zyp/jb_workspace/cell2sentence-master/20250212_cross_batch_data_processed/prediction_set/Human2_heart_combined.csv",]})
