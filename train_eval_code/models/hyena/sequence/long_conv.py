...
from models.hyena.nn import LinearActivation, Activation, DropoutNd
from models.hyena.sequence.block_fft import BlockFFT
from models.hyena.sequence.long_conv_kernel import LongConvKernel
...
class LongConv(nn.Module):
    def __init__(
        ...
        super().__init__()
        if verbose:
            import models.hyena.utils.train
            log = models.hyena.utils.train.get_logger(__name__)
