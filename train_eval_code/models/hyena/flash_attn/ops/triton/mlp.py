...
from models.hyena.flash_attn.ops.triton.linear import triton_linear_act, triton_dgrad_act
from models.hyena.flash_attn.ops.activations import sqrelu_fwd, sqrelu_bwd
